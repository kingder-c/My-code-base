  ...
  PopupTemplate, GraphicsLayer
    ...
    return declare([GraphicsLayer], {
        constructor: function (options) {
            ...
            this._graphictype = options.type || '';
        },
        ...
        _updateLabel: function (c) {
            ...
            if (label.length == 1) {
                ...
                //添加文字标注
                //var label = new TextSymbol("123", { size: "14", style: "normal", weight: 'BOLD', family: "微软雅黑" }, [0, 0, 0]).setOffset(0, -36);
